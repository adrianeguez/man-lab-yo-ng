...
function generarInputTexto(nombre, nombreCampo, nombreClase, claseContenedor, claseLabel, claseInput, claseMensajes, moduloInternacionalizacion, opcionesCampo: ArgumentosCampoInteraface) {
            ...
            <div class="col-sm-6 ${claseContenedor}" *ngIf="!configuracionDisabled.${nombreCampo}.hidden">
                <div class="row">
                    <label class="col-sm-4 ${claseLabel}" [for]="${nombreClase}.mensajesValidacion${nombreCampo}.nombreInput">
                        {{
                            ${moduloInternacionalizacion ? (
        `t('${nombre}.' + ${nombreClase}.mensajesValidacion${nombreCampo}.nombreInput)`
    ) : (
        `${nombreClase}.mensajesValidacion${nombreCampo}.nombreAPresentarse`
    )}
                        }}
                        </label>
                    <div class="col-sm-8">
                        <input type="${opcionesCampo.tipoControl.tipoCampoHtml}"
                                ...
                                [placeholder]="${moduloInternacionalizacion ? (
        `t('${nombre}.' + ${nombreClase}.mensajesValidacion${nombreCampo}.tooltip)`
    ) : (
        `${nombreClase}.mensajesValidacion${nombreCampo}.tooltip`
    )} "
                                [title]="${moduloInternacionalizacion ? (
        `t('${nombre}.' + ${nombreClase}.mensajesValidacion${nombreCampo}.title)`
    ) : (
        `${nombreClase}.mensajesValidacion${nombreCampo}.title`
    )} "
...
function generarInputBooleano(nombre, nombreCampo, nombreClase, claseContenedor, claseLabel, claseInput, claseMensajes, moduloInternacionalizacion, opciones: string) {
