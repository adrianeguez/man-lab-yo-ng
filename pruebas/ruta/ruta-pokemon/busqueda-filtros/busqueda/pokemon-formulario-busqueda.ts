...
import {POKEMON_BUSQUEDA_CAMPO_TEXTO_BUSQUEDA} from './pokemon-busqueda-campo-texto-busqueda';
import {POKEMON_BUSQUEDA_CAMPO_SELECT_HABILITADO} from './pokemon-busqueda-campo-select-habilitado';


export const POKEMON_FORMULARIO_BUSQUEDA: (claseComponente: any) => CampoFormulario[] = (claseComponente: any) => {
  return [
    POKEMON_BUSQUEDA_CAMPO_TEXTO_BUSQUEDA(claseComponente),
    POKEMON_BUSQUEDA_CAMPO_SELECT_HABILITADO(claseComponente)
  ];
};
